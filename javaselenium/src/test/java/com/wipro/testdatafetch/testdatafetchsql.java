package com.wipro.testdatafetch;
...
public class testdatafetchsql {
	private static final org.apache.logging.log4j.Logger log = LoggerHelper.getLogger(testdatafetchsql.class);
	@Test
	...
	// fetch the db url , password and username of the my sql db 
		...
		String query = "select * from patient2";
		// pass the query to result set
		ResultSet rs = st.executeQuery(query);
		while (rs.next()) {
			String usrname = rs.getString("pname");
			String paswd = rs.getString("id");
